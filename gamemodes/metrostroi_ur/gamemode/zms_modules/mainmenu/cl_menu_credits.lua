...
hook.Add("ZMS.PauseMenu.InitTabs", "ZMS.PauseMenu.InitTabs.Credits", function(menu_panel, prepare_html)
    menu_panel:AddMenuTab("Разработчики", function(root)
        local pnl = root:Add("DHTML")
        prepare_html(pnl, html_str)
        return pnl
    end)
end)
